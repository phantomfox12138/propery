...
public class ForgetActivity extends FragmentActivity implements ForgetFirstFragment.IForgetFirstClickListener,ForgetSecondFragment.IForgetSecondClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.forget_content, forgetFirstFragment, "forgetFirst");
