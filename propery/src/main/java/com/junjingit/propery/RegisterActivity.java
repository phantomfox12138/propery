...
public class RegisterActivity extends FragmentActivity implements RegisterFirstFragment.IRegisterFirstClickListener,RegisterSecondFragment.IRegisterSecondClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.register_content,registerFirstFragment,"registerFirst");
    ...
    public void onNextAction(String mobile, String messageCode) {
        ...
        tx.replace(R.id.register_content, registerSecondFragment, "registerSecond");
