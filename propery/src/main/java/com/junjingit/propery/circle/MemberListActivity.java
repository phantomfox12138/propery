...
public class MemberListActivity extends AppCompatActivity implements MemberListAdapter.IClickListener {
    ...
    private SwipeMenuItemClickListener mMenuItemClickListener = new SwipeMenuItemClickListener() {
        ...
        public void onItemClick(SwipeMenuBridge menuBridge) {
            ...
            if (direction == SwipeMenuRecyclerView.RIGHT_DIRECTION) {
                ...
                Log.v(TAG, "##############打印当前成员的Id" + mDataList.get(adapterPosition).getObjectId());
                ...
                if (e == null) {
                    ...
                    todo.saveInBackground(new SaveCallback() {
                        ...
                        public void done(AVException e) {
                            if (e == null) {
                                ToastUtils.showToast(MemberListActivity.this, "禁言成功");
                                //刷新列表更改状态[文字改变]
                                initData();
                            } else {
                                ToastUtils.showToast(MemberListActivity.this, "禁言失败");
                            }
                        }
                    });
                } else {
