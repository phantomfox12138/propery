...
public class ExpansionPanel extends FrameLayout
{
    ...
    {
        @LayoutRes
        int collapsedLayoutId = R.layout.expansion_panel_collapsed_default;
        @LayoutRes
        int expandedLayoutId = R.layout.expansion_panel_expanded_default;
        ...
        try
        {
            mExpanded = a.getBoolean(R.styleable.ExpansionPanel_defaultExpanded,
                    false);
            
            collapsedLayoutId = a.getResourceId(R.styleable.ExpansionPanel_collapsedLayout,
                    collapsedLayoutId);
            expandedLayoutId = a.getResourceId(R.styleable.ExpansionPanel_expandedLayout,
                    expandedLayoutId);
            
            mToggleOnCollapsedClickEnabled = a.getBoolean(R.styleable.ExpansionPanel_toggleOnCollapsedClickEnabled,
                    true);
            mToggleOnExpandedClickEnabled = a.getBoolean(R.styleable.ExpansionPanel_toggleOnExpandedClickEnabled,
                    true);
        ...
        mMainLayout = (FrameLayout) inflater.inflate(R.layout.expansion_panel,
                this,
                false);
    ...
    public void hideStateIcon(boolean flag)
    {
        if (null != mStateIcon)
        {
            mStateIcon.setVisibility(flag ? View.GONE : View.VISIBLE);
        }
    }
    ...
    {
        setCollapsedView(LayoutInflater.from(getContext())
                .inflate(collapsedViewId, mContentLayout, false));
    }
    ...
    {
        setExpandedView(LayoutInflater.from(getContext())
                .inflate(expandedViewId, mContentLayout, false));
    }
    
    private int getContentMeasuredHeight(View view, int minHeight,
            int paddingTop, int paddingBottom)
    {
        view.measure(FrameLayout.LayoutParams.MATCH_PARENT,
    ...
    private void measureCollapsedHeight()
    {
        mCollapsedHeight = getContentMeasuredHeight(mCollapsedView,
                ...
                mCollapsedPaddingTop,
                mCollapsedPaddingBottom);
    }
    ...
    private void checkHeights()
    {
        ...
        {
            if (mCollapsedHeight == height)
                return;
        }
        
        if (isShown() && mDurationContentHeightChanged > 0)
        {
            final ValueAnimator resizePanelValueAnimator = ValueAnimator.ofInt(height,
        ...
        {
            setState(UPDATING);
            setContentLayoutHeight(mExpanded ? mExpandedHeight
                    : mCollapsedHeight);
            setState(mExpanded ? EXPANDED : COLLAPSED);
        }
    }
    ...
    public void setExpanded(boolean expanded, final boolean animate)
    {
        ...
        {
            final ValueAnimator resizePanelAnimator = ValueAnimator.ofInt(getContentLayoutHeight(),
                    mExpanded ? mExpandedHeight : mCollapsedHeight);
            ...
            final PropertyValuesHolder holderPaddingBottom = ofInt(PROPERTY_NAME_PADDING_BOTTOM,
                    ...
                    mExpanded ? mExpandedPaddingBottom
                            : mCollapsedPaddingBottom);
            
            final ValueAnimator resizePaddingAnimator = ValueAnimator.ofPropertyValuesHolder(holderPaddingTop,
                    holderPaddingBottom);
            ...
            resizePaddingAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
            {
                ...
                public void onAnimationUpdate(ValueAnimator animation)
                {
                    setMainLayoutPadding((int) animation.getAnimatedValue(PROPERTY_NAME_PADDING_TOP),
            ...
            final ValueAnimator rotateIconAnimator = ValueAnimator.ofFloat(stateIconRotation,
                    mExpanded ? 180f : 0f);
            ...
            final long durationExpandedViewChangeVisibility = mDurationToggle
            ...
            if (mExpanded)
            {
                ...
                {
                    duration = (long) (mDurationToggle
                            * (180f - stateIconRotation) / 180f);
                    ...
                    else if (duration < (durationCollapsedViewChangeVisibility + durationExpandedViewChangeVisibility))
                    {
                        ...
                        durationHide = duration
                                - durationExpandedViewChangeVisibility;
                        durationShow = durationExpandedViewChangeVisibility;
                    }
                    else
                    {
                        delay = duration
                                - (durationCollapsedViewChangeVisibility + durationExpandedViewChangeVisibility);
                        durationHide = durationCollapsedViewChangeVisibility;
                        durationShow = durationExpandedViewChangeVisibility;
                    }
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        durationShow = durationCollapsedViewChangeVisibility;
                        durationHide = duration
                                - (delayCollapsedViewHiding + durationCollapsedViewChangeVisibility);
                    }
                }
            }
            ...
            if (delay > 0)
                mChangeViewAnimatorSet.setStartDelay(delay);
            
            if (hideAnimator != null && showAnimator != null)
            {
                mChangeViewAnimatorSet.playSequentially(hideAnimator,
                        showAnimator);
            }
            else
            {
                if (showAnimator != null)
                    mChangeViewAnimatorSet.play(showAnimator);
                if (hideAnimator != null)
                    mChangeViewAnimatorSet.play(hideAnimator);
            }
            ...
            mAnimatorSet.playTogether(resizePanelAnimator,
            ...
            mAnimatorSet.addListener(new AnimatorListenerAdapter()
            {
                ...
                public void onAnimationStart(Animator animation)
                {
                    ((InputMethodManager) getContext().getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(getWindowToken(),
                            0);
                }
        ...
        else
        {
            ...
            if (mExpanded)
            {
                ...
                setMainLayoutPadding(mExpandedPaddingTop,
                        mExpandedPaddingBottom);
            ...
            else
            {
                ...
                setMainLayoutPadding(mCollapsedPaddingTop,
                        mCollapsedPaddingBottom);
    ...
    public void setToggleOnExpandedClickEnabled(
            boolean toggleOnExpandedClickEnabled)
    {
        mToggleOnExpandedClickEnabled = toggleOnExpandedClickEnabled;
        if (mExpanded)
            mMainLayout.setClickable(mToggleOnExpandedClickEnabled);
    }
    ...
    public void setToggleOnCollapsedClickEnabled(
            boolean toggleOnCollapsedClickEnabled)
    {
        mToggleOnCollapsedClickEnabled = toggleOnCollapsedClickEnabled;
        if (!mExpanded)
            mMainLayout.setClickable(mToggleOnCollapsedClickEnabled);
    }
    ...
    {
        mDurationToggle = durationToggle >= 0 ? durationToggle
                : getResources().getInteger(R.integer.expansion_panel_animation_duration_toggle);
    }
    ...
    {
        mDelayCollapsedViewHiding = delayCollapsedViewHiding >= 0 ? delayCollapsedViewHiding
                : getResources().getInteger(R.integer.expansion_panel_animation_delay_collapsed_view_hiding);
    }
    ...
    public void setDurationCollapsedViewChangeVisibility(
            long durationCollapsedViewChangeVisibility)
    {
        mDurationCollapsedViewChangeVisibility = durationCollapsedViewChangeVisibility >= 0 ? durationCollapsedViewChangeVisibility
                : getResources().getInteger(R.integer.expansion_panel_animation_duration_collapsed_view_change_visibility);
    }
    ...
    public void setDurationContentHeightChanged(
            long durationContentHeightChanged)
    {
        mDurationContentHeightChanged = durationContentHeightChanged >= 0 ? durationContentHeightChanged
                : getResources().getInteger(R.integer.expansion_panel_animation_duration_content_height_changed);
    }
