...
public class TagCloudLinkView extends RelativeLayout
{
    ...
    private static final float DEFAULT_DELETABLE_TEXT_COLOR = Float.valueOf(Color.parseColor("#1a1a1a"));
    ...
    private void initialize(Context ctx, AttributeSet attrs, int defStyle)
    {
        ...
        TypedArray typeArray = ctx.obtainStyledAttributes(attrs,
                R.styleable.TagCloudLinkView,
                defStyle,
                defStyle);
        mTagLayoutColor = typeArray.getColor(R.styleable.TagCloudLinkView_tagLayoutColor,
                DEFAULT_TAG_LAYOUT_COLOR);
        mTagTextColor = typeArray.getColor(R.styleable.TagCloudLinkView_tagTextColor,
                DEFAULT_TAG_TEXT_COLOR);
        mTagTextSize = typeArray.getDimension(R.styleable.TagCloudLinkView_tagTextSize,
                DEFAULT_TEXT_SIZE);
        mIsDeletable = typeArray.getBoolean(R.styleable.TagCloudLinkView_isDeletable,
                false);
        mDeletableTextColor = typeArray.getColor(R.styleable.TagCloudLinkView_deletableTextColor,
                DEFAULT_TAG_TEXT_COLOR);
        mDeletableTextSize = typeArray.getDimension(R.styleable.TagCloudLinkView_deletableTextSize,
    ...
    public void drawTags()
    {
        ...
        for (Tag item : mTags)
        {
            ...
            tagView.setPadding(INNER_VIEW_PADDING,
                    INNER_VIEW_PADDING,
                    INNER_VIEW_PADDING,
                    INNER_VIEW_PADDING);
            ...
            tagView.setOnClickListener(new OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        mSelectListener.onTagSelected(TagCloudLinkView.this,
                                tag,
                                position);
                    }
                }
            ...
            if (mIsDeletable)
            {
                ...
                deletableView.setPadding(INNER_VIEW_PADDING,
                        INNER_VIEW_PADDING,
                        INNER_VIEW_PADDING,
                        INNER_VIEW_PADDING);
                ...
                deletableView.setOnClickListener(new OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        if (mDeleteListener != null)
                        {
                            ...
                            mDeleteListener.onTagDeleted(TagCloudLinkView.this,
                                    targetTag,
                                    position);
                        }
                    }
                ...
                tagWidth += deletableView.getPaint()
                        .measureText(DEFAULT_DELETABLE_STRING)
    ...
    {
        void onTagSelected(TagCloudLinkView view, Tag tag, int position);
    }
    ...
    {
        void onTagDeleted(TagCloudLinkView view, Tag tag, int position);
    }
