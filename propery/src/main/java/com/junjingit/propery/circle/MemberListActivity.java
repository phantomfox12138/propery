    ...
    private SwipeMenuItemClickListener mMenuItemClickListener = new SwipeMenuItemClickListener()
    {
        ...
        public void onItemClick(SwipeMenuBridge menuBridge)
        {
            ...
            if (direction == SwipeMenuRecyclerView.RIGHT_DIRECTION)
            {
                ...
                {
                    myMemberDelete(mDataList.get(adapterPosition).getObjectId(),
                            adapterPosition);
                }
            }
        }
        ...
        queryMember.findInBackground(new FindCallback<AVUser>()
        {
            ...
            public void done(List<AVUser> list, AVException e)
            {
                if (e == null)
                {
                    ...
                    String currentValue = memberDataList.get(memberPosition)
                            .getObjectId();
                    for (int i = 0; i < memberDataList.size(); i++)
                    {
                        String tempValue = memberDataList.get(i)
                                .getObjectId()
                                .toString();
                    ...
                    AVObject todoFolder = AVObject.createWithoutData("_User",
